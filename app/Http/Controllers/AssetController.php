...
class AssetController extends Controller
{
    ...
    public function renewThing(Request $request, $id) {
        ...
        $response = @file_get_contents("http://127.0.0.1:64989/game/renew/".$id."/360?key=".$arbiterkey);
        return "a";
    }
...
public function deletePort(Request $request, $id) {
    ...
    DB::table('ports')
        ->where('id', $id)
        ->delete();
	$response = @file_get_contents("http://127.0.0.1:64989/game/stop/".$id."?key=". $arbiterkey);
	return "a";
}
